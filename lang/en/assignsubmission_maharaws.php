...
$string['groups:groupselector:nogroups'] = 'No groups are available for selection';
$string['groups:groupselector:nogroups_help'] = 'All existing groups have been mapped to a different institution. Please set up some new groups then refresh this page.';
$string['groups:groupselector_help'] = 'CTRL+click to multi-select groups. If a group already exists it will be mapped to this assignment. If it doesn\'t exist it will be created in Mahara, then mapped to this assignment.';
$string['groups:institution'] = "Institution (only required for Mahara 26.04+)";
$string['groups:institution_help'] = "The shortname of the Mahara institution the web service belongs to (value displayed for information only in the assignment settings).";
...
$string['groups:usergroups'] = 'You are in more than one group for this assignment but you can only be in one Moodle group per Mahara assignment. No portfolios will be displayed until this has been corrected by your teacher.';
