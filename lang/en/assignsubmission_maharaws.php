...
$string['defaultusernameattribute'] = 'Default username attribute';
$string['defaultusernameattribute_help'] = 'Default Moodle user field to store in new Mahara assignment points for username matching. Existing assignment points keep their current value.';
...
$string['usernameattribute:email'] = 'email';
$string['usernameattribute:idnumber'] = 'idnumber';
$string['usernameattribute:username'] = 'username';
