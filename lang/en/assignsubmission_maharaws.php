...
$string['errorvieworcollectionalreadysubmitted'] = 'The selected Mahara page or collection could not be submitted. Please choose another.';
...
$string['noviewscreated'] = 'You have no available Mahara pages or collections. Please visit "{$a->name}" and <a href="{$a->jumpurl}" target="_blank" rel="noopener noreferrer">create a new one</a>.';
